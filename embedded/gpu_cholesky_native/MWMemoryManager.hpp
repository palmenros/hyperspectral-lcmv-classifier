...
class MemoryConfig {
  public:
     ...
     */
    void update(size_t minPoolSize, MallocMode lastMode, bool startFromCurrentSizeLevel=true);
...
class MemoryPool {
  public:
    ...
    size_t size() const;
    /**
     * Returns sum of allocate block size.
     */
...
class MemoryManager {
  public:
    ...
    size_t getTotalNonEmptyPoolSize() const;
    size_t getTotalAllocatedBlockSize() const;
    void freeEmptyPools();
    size_t freeEmptyPoolsAndFindMaxPoolSize(PoolList& list);
