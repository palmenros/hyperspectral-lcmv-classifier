 ...
 * Return Type  : void
 */
void main_native_multi_target_detection_ldl(void)
{
  static float fv2[692224];
  float fv[2535];
  float W[507];
  float fv1[45];
  ...
  argInit_169x15_real32_T(fv);
  argInit_15x3_real32_T(fv1);
  argInit_4096x169_real32_T(fv2);
  native_multi_target_detection_ldl(fv, fv1, fv2, W);
}
